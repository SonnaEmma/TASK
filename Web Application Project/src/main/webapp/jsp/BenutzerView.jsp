  ...
  <div class="tab-content custom-tab-content">
	  ...
	  >
	   ...
	   <form action="../jsp/TaskAppl.jsp" method="get" onsubmit="return checkInput(this)">
	      ...
	      <div id="errorFunction" class="fehlerfeld"></div>
	      <div data-mdb-input-init class="form-outline mb-4">
	        <input type="text" id="registerFunction" class="form-control custom-input" name="rolle" value="" 
	        placeholder="Function" required onkeyup="checkRolle(this.value)" />
	        
	      </div>
	      
	      <div id="errorDepartment" class="fehlerfeld"></div>
	      <div data-mdb-input-init class="form-outline mb-4">
	        <input type="text" id="registerDepartment" class="form-control custom-input" name="abteilung" value="" 
	        placeholder="Department name" required onkeyup="checkDepartment(this.value)"/>
